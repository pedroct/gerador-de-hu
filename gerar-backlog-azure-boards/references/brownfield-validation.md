...
No Markdown final, não reproduza a matriz: associe somente a evidência relevante a cada item em
`##### Implementation Evidence` ou em síntese explicitamente rotulada na Description/Conversation;
