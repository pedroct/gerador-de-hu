...
uv run python scripts/publicar_backlog_demanda.py planejar backlog.md --iteration-path 'Projeto\\Sprint 18'
uv run python scripts/publicar_backlog_demanda.py publicar backlog.md --simulacao
uv run python scripts/publicar_backlog_demanda.py publicar backlog.md --validar-apenas
